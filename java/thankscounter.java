...
public class thankscounter extends EvalFunc<Integer> {

	@Override
	// Count the number of word "thanks" occurrences
	public Integer exec(Tuple arg0) throws IOException {
		...
		try	{
			Integer love = 0;
			Pattern pattern = Pattern.compile("спасибо", Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CASE);
